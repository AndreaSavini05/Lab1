...
class Simulation {
  /*double k = gRandom->Gaus(5.2, 0.035);
  double phi = gRandom->Gaus(1.8, 0.03);
  double b = gRandom->Gaus(0.2, 0.001);*/
  double x_min = 0;
  double x_max = 1;
  Data data;
  int N_extract;
 ...
 public:
  TF1* makeFunction() {
    ...
    f1->SetParameter(0, gRandom->Gaus(5.2, 0.035));  // k
    f1->SetParameter(1, gRandom->Gaus(1.8, 0.03));   // phi
    f1->SetParameter(2, gRandom->Gaus(0.2, 0.001));  // b
    return f1;
  };
